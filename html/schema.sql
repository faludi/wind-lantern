...
CREATE TABLE lanterns (
    ...
    color_temperature TINYINT NOT NULL DEFAULT 0 CHECK (color_temperature BETWEEN -10 AND 10),
    flicker_intensity DECIMAL(4,2) NOT NULL DEFAULT 1.00 CHECK (flicker_intensity BETWEEN 0 AND 20),
