...
ALTER TABLE lanterns
    ...
    ADD COLUMN night_brightness TINYINT UNSIGNED NOT NULL DEFAULT 10
        CHECK (night_brightness BETWEEN 0 AND 100) AFTER lantern_brightness,
    ADD COLUMN night_start TINYINT UNSIGNED NOT NULL DEFAULT 11
        CHECK (night_start BETWEEN 0 AND 23) AFTER night_brightness,
    ADD COLUMN night_end TINYINT UNSIGNED NOT NULL DEFAULT 11
